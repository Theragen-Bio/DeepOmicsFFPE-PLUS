...
if __name__ == "__main__":
    ...
    print("\n" + "*"*60)
    print(f"* Stage 4: Postprocessing STARTED at {stage_start.strftime('%Y-%m-%d %H:%M:%S')} {local_tz_abbr}")
    print("*"*60 + "\n")
    ...
    try:
        ...
        print("\n" + "*"*60)
        print(f"* Stage 4: Postprocessing COMPLETED at {stage_end.strftime('%Y-%m-%d %H:%M:%S')} {local_tz_abbr}")
        print("*"*60 + "\n")
